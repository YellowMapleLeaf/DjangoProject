# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-05-13 12:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_img', models.ImageField(upload_to='upload', verbose_name='文章标题图片')),
                ('status', models.CharField(choices=[('draft', '草稿'), ('published', '已发布'), ('hidden', '隐藏')], default='published', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signatrue', models.CharField(blank=True, max_length=255, null=True)),
